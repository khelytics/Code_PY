...
Trained_precision = cross_val_score(clf, train[training_features], train[target], scoring='precision')
Trained_recall = cross_val_score(clf, train[training_features], train[target], scoring='recall')

Hold_precision = cross_val_score(clf, train[training_features], train[target], scoring='precision')
Hold_recall = cross_val_score(clf, train[training_features], train[target], scoring='recall')

#average_precision = average_precision_score(train[target], trained_model.predict(train[training_features]))

print('Trained Precision:' Trained_precision ) 
print('Trained Recall:' Trained_recall ) 
 
print('Hold Precision:' Hold_precision ) 
print('Hold Recall:' Hold_recall ) 
